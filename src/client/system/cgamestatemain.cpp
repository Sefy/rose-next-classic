    ...
    if (g_GameDATA.m_bDisplayDebugInfo) {
        ...
        if (g_pAVATAR->GetCur_SummonCNT() > 0) {
            ::drawFontf(g_GameDATA.m_hFONT[FONT_LARGE_BOLD],
                ...
                150,
                g_dwYELLOW,
                "[ 현재 소환된 몹 수[ %d ] , 현재 사용한 소환량[%d] ]/ 현재 소환가능한 소환량[%d]",
        ...
        ::drawFontf(g_GameDATA.m_hFONT[FONT_NORMAL],
            ...
            40,
            g_dwRED,
            "TotOBJ: %d, CnstOBJ: %d, Item : %d, TreeOBJ: %d, MobCNT: %d, EffectCNT: %d, PatchCNT: "
            "%d ",
        ...
        ::drawFontf(g_GameDATA.m_hFONT[FONT_NORMAL],
            ...
            100,
            g_dwRED,
            "( WorldRATE: %d, WorldPROD:%d, Country Code:%d )",
            Get_WorldRATE(),
            Get_WorldPROD(),
            0);
    }
