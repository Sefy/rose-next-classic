...
//-------------------------------------------------------------------------------------------------
short
CBasicDATA::GetPartModelCount(short nPartIdx, bool bIsFemale) {
...
CBasicDATA::Load3DDATA() {
    ...
    m_pMD_CharPARTS[0][BODY_PART_HAIR]->Load("3Ddata\\avatar\\LIST_mHAIR.ZSC",
        BONE_IDX_HEAD); // link to bone
    ...
    m_pMD_CharPARTS[1][BODY_PART_HAIR]->Load("3Ddata\\avatar\\LIST_wHAIR.ZSC",
        BONE_IDX_HEAD); // link to bone
    ...
    m_pMD_CharPARTS[0][BODY_PART_FACE_ITEM]->Load("3Ddata\\avatar\\LIST_FACEIEM.ZSC",
        -1,
        DUMMY_IDX_MOUSE);
    ...
    m_MatOCEAN = ::loadOceanMaterial("mat_ocean",
        ...
        "3DDATA\\JUNON\\Water\\ocean01_01.dds");
    if (m_MatOCEAN) {
...
bool
CBasicDATA::LoadZoneData(short nZoneNO) {
