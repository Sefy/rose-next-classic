...
//-------------------------------------------------------------------------------------------------
void
F_AIACT00(stActHead* pActDATA, t_AIPARAM* pEVENT) {
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT01(stActHead* pActDATA, t_AIPARAM* pEVENT) {
    /*
    struct		AIACT01
    {
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT02(stActHead* pActDATA, t_AIPARAM* pEVENT) {
    /*
    struct		AIACT02
    {
        DWORD			dwSize ;					// 이 스트럭쳐의 크기
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT03(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    ...
    */
    ...
    float fPosX, fPosY;
    fPosX =
        pEVENT->m_pSourCHAR->Get_CurXPOS() + AI_SysRANDOM(pAct->iDistance * 2) - pAct->iDistance;
    fPosY =
        pEVENT->m_pSourCHAR->Get_CurYPOS() + AI_SysRANDOM(pAct->iDistance * 2) - pAct->iDistance;

    pEVENT->m_pSourCHAR->SetCMD_MOVE2D(fPosX, fPosY, pAct->cSpeed);
}
//-------------------------------------------------------------------------------------------------
void
F_AIACT04(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    ...
    */
    ...
    float fPosX, fPosY;
    fPosX =
        pEVENT->m_pSourCHAR->Get_BornXPOS() + AI_SysRANDOM(pAct->iDistance * 2) - pAct->iDistance;
    fPosY =
        pEVENT->m_pSourCHAR->Get_BornYPOS() + AI_SysRANDOM(pAct->iDistance * 2) - pAct->iDistance;
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT05(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT06(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT07(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT08(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT09(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    /*
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT10(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    /*
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT11(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    ...
    */
    ...
    int iFindCNT = 0;
    while (pFindCHAR) {
        if ((pEVENT->m_pSourCHAR != pFindCHAR) && pEVENT->m_pSourCHAR->Is_SameTEAM(pFindCHAR)
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT12(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT13(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT14(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    ...
    */
    ...
    CAI_OBJ* pFindCHAR = pEVENT->m_pSourCHAR->AI_FindFirstOBJ(pAct->iDistance);
    while (pFindCHAR) {
        if ((pEVENT->m_pSourCHAR != pFindCHAR) && pFindCHAR->Get_CharNO() == CharNO
            && pEVENT->m_pSourCHAR->Is_SameTEAM(pFindCHAR) && pFindCHAR->Get_TARGET() == NULL) {
            pFindCHAR->SetCMD_RUNnATTACK(pTarget->Get_TAG());
        }
        pFindCHAR = pEVENT->m_pSourCHAR->AI_FindNextOBJ();
    }
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT15(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT16(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT17(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT18(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    ...
    */
    ...
    WORD wHowMany = 0;
    while (pFindCHAR) {
        if ((pEVENT->m_pSourCHAR != pFindCHAR) && pFindCHAR->Get_CharNO() == pAct->cMonster
            && pEVENT->m_pSourCHAR->Is_SameTEAM(pFindCHAR) && pFindCHAR->Get_TARGET() == NULL) {
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT19(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    /*
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT20(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#if !defined(__SERVER) && !defined(__VIRTUAL_SERVER)
    return;
#endif
    /*
     * Struct Name : AIACT20 - <<2004.1.29 추가>>
     * 지정된 몬스터를 소환시킨다. 자신/공격자(자신을 공격한 캐릭터)/공격타겟(자신이 공격하는
    캐릭터).
     * 근처 ?미터 이내에 소환
     * 추가설명 : 마리수는 1마리이다.
    struct AIACT20
    {
        ...
        WORD		cMonster;			/// 몬스터번호
        BYTE		btPos;				/// 소환위치 : 0 = 자신 주위,  1 = 공격자 주위(자신을
    공격한), 2 = 공격타겟 주위(자신이 공격하고 있는) int			iDistance ;			// 거리 . 이
    거리 이내에 소환
    };
    */
...
*/
    ...
    switch (pAct->btTarget) {
        ...
        case 1: {
            CAI_OBJ* pTarget = pEVENT->m_pSourCHAR->Get_TARGET();
            if (pTarget) {
                pEVENT->m_pSourCHAR->SetCMD_Skill2OBJ(pTarget->Get_TAG(),
                    pAct->nSkill,
                    pAct->nMotion);
            }
            break;
...
void
F_AIACT28(stActHead* pActDATA, t_AIPARAM* pEVENT) {
    /*
    struct AIACT28
    {
        DWORD		dwSize;			/// 이 스트럭쳐의 크기
...
void
F_AIACT29(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#ifdef __SERVER
...
void
F_AIACT30(stActHead* pActDATA, t_AIPARAM* pEVENT) {
#ifdef __SERVER
...
void
F_AIACT33(stActHead* pActDATA, t_AIPARAM* pEVENT) {
/*
...
void
F_AIACT34(stActHead* pActDATA, t_AIPARAM* pEVENT) {
/*
// 주인캐릭터에게 아이템 지급
struct AIACT34
{
...
void
F_AIACT35(stActHead* pActDATA, t_AIPARAM* pEVENT) {
/*
// 몬스터 변수 값 변경
struct	AIACT35
{
...
void
F_AIACT36(stActHead* pActDATA, t_AIPARAM* pEVENT) {
    /*
...
void
F_AIACT37(stActHead* pActDATA, t_AIPARAM* pEVENT) {
    /*
...
//-------------------------------------------------------------------------------------------------
void
F_AIACT_NULL(stActHead* pActDATA, t_AIPARAM* pEVENT) {
    ;
}
